...
export class DataManagerService {
  ...
  private url: string = 'https://blooming-taiga-18152.herokuapp.com/';
  ...
  employeeGetAllRaw(): Observable<Employee[]> {
    return this.teamsApi.get<Employee[]>(`${this.url}employees-raw `);
  }
